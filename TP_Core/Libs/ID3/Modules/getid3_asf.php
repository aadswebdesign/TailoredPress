    ...
    class getid3_asf extends getid3_handler{
        public function __construct(getID3 $getid3) {
            ...
            foreach ($GUIDarray as $GUIDname => $hexstringvalue) {
                if (!defined($GUIDname)) {
                    define($GUIDname, self::GUIDtoBytestring($hexstringvalue));
                }
            }
        }//26
        public function Analyze():bool {
            ...
            if ($thisfile_asf_headerobject['objectid'] != GETID3_ASF_Header_Object) {
                ...
                return $this->error('ASF header GUID {'.self::BytestringToGUID($thisfile_asf_headerobject['objectid']).'} does not match expected "GETID3_ASF_Header_Object" GUID {'.$this->BytestringToGUID(GETID3_ASF_Header_Object).'}');
            }
                ...
                switch ($NextObjectGUID) {
                    case GETID3_ASF_File_Properties_Object:
                        ...
                        if ($thisfile_asf_filepropertiesobject['flags']['broadcast']) {
                            unset($thisfile_asf_filepropertiesobject['filesize'],$thisfile_asf_filepropertiesobject['data_packets'],
                                $thisfile_asf_filepropertiesobject['play_duration'],$thisfile_asf_filepropertiesobject['send_duration'],
                                $thisfile_asf_filepropertiesobject['min_packet_size'],$thisfile_asf_filepropertiesobject['max_packet_size']);
                        } else {
                    ...
                    case GETID3_ASF_Header_Extension_Object:
                        ...
                        if ($thisfile_asf_headerextensionobject['reserved_1'] !== GETID3_ASF_Reserved_1) {
                            $this->warning('header_extension_object.reserved_1 GUID ('.self::BytestringToGUID($thisfile_asf_headerextensionobject['reserved_1']).') does not match expected "GETID3_ASF_Reserved_1" GUID ('.$this->BytestringToGUID(GETID3_ASF_Reserved_1).')');
                            //return false;
                            break;
                        }
                    ...
                    case GETID3_ASF_Codec_List_Object:
                        ...
                        if ($thisfile_asf_codeclistobject['reserved'] !== self::GUIDtoBytestring('86D15241-311D-11D0-A3A4-00A0C90348F6')) {
                            $this->warning('codec_list_object.reserved GUID {'.self::BytestringToGUID($thisfile_asf_codeclistobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {86D15241-311D-11D0-A3A4-00A0C90348F6}');
                            //return false;
                            break;
                        }
                        ...
                        for ($CodecEntryCounter = 0; $CodecEntryCounter < $thisfile_asf_codeclistobject['codec_entries_count']; $CodecEntryCounter++) {
                            ...
                            if ($thisfile_asf_codeclistobject_codecentries_current['type_raw'] === 2) { // audio codec
                                if (strpos($thisfile_asf_codeclistobject_codecentries_current['description'], ',') === false) {
                                    ...
                                    if (!isset($thisfile_audio['bitrate']) && strpos($AudioCodecBitrate, 'kbps') !== false) {
                                    ...
                                    if (!isset($thisfile_audio['channels'])) {
                                        if (strpos($AudioCodecChannels, 'stereo') !== false) {
                                            $thisfile_audio['channels'] = 2;
                                        } elseif (strpos($AudioCodecChannels, 'mono') !== false) {
                    ...
                    case GETID3_ASF_Script_Command_Object:
                        ...
                        if ($thisfile_asf_scriptcommandobject['reserved'] !== self::GUIDtoBytestring('4B1ACBE3-100B-11D0-A39B-00A0C90348F6')) {
                            $this->warning('script_command_object.reserved GUID {'.self::BytestringToGUID($thisfile_asf_scriptcommandobject['reserved']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4B1ACBE3-100B-11D0-A39B-00A0C90348F6}');
                            //return false;
                            break;
                        }
                    ...
                    case GETID3_ASF_Marker_Object:
                        ...
                        if ($thisfile_asf_markerobject['reserved'] !== self::GUIDtoBytestring('4CFEDB20-75F6-11CF-9C0F-00A0C90349CB')) {
                            $this->warning('marker_object.reserved GUID {'.self::BytestringToGUID($thisfile_asf_markerobject['reserved_1']).'} does not match expected "GETID3_ASF_Reserved_1" GUID {4CFEDB20-75F6-11CF-9C0F-00A0C90349CB}');
                            break;
                        }
                    ...
                    case GETID3_ASF_Bitrate_Mutual_Exclusion_Object:
                        ...
                        if (($thisfile_asf_bitratemutualexclusionobject['reserved'] !== GETID3_ASF_Mutex_Bitrate) && ($thisfile_asf_bitratemutualexclusionobject['reserved'] != GETID3_ASF_Mutex_Unknown)) {
                            $this->warning('bitrate_mutual_exclusion_object.reserved GUID {'.self::BytestringToGUID($thisfile_asf_bitratemutualexclusionobject['reserved']).'} does not match expected "GETID3_ASF_Mutex_Bitrate" GUID {'.$this->BytestringToGUID(GETID3_ASF_Mutex_Bitrate).'} or  "GETID3_ASF_Mutex_Unknown" GUID {'.$this->BytestringToGUID(GETID3_ASF_Mutex_Unknown).'}');
                            //return false;
                            break;
                        }
                                ...
                                case 'tracknumber':
                                    ...
                                    foreach ($thisfile_asf_comments['track_number'] as $key => $value) {
                                        if (preg_match('/^[0-9\x00]+$/', $value)) {
                                            $thisfile_asf_comments['track_number'][$key] = (int)str_replace("\x00", '', $value);
                                        }
                                    }
                                    break;
                                case 'wm/track':
                                    if (empty($thisfile_asf_comments['track_number'])) {
                                        $thisfile_asf_comments['track_number'] = array(1 + (int) self::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value']));
                                    }
                                    break;
                                case 'wm/year':
                                case 'year':
                                ...
                                default:
                                    switch ($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['value_type']) {
                                        case 0: // Unicode string
                                            if (strpos(self::TrimConvert($thisfile_asf_extendedcontentdescriptionobject_contentdescriptor_current['name']), 'WM/') === 0) {
                    ...
                    default:
                        ...
                        if (self::GUIDname($NextObjectGUIDtext)) {
                            $this->warning('unhandled GUID "'.self::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF header at offset '.($offset - 16 - 8));
                        } else {
                ...
                foreach ($thisfile_asf['stream_properties_object'] as $streamnumber => $streamdata) {
                    switch ($streamdata['stream_type']) {
                        case GETID3_ASF_Audio_Media:
                            ...
                            } else if (!empty($thisfile_asf_audiomedia_currentstream['bytes_sec'])) {
            ...
            while ($this->ftell() < $info['avdataend']) {
                ...
                switch ($NextObjectGUID) {
                    ...
                    default:
                        // Implementations shall ignore any standard or non-standard object that they do not know how to handle.
                        if (self::GUIDname($NextObjectGUIDtext)) {
                            $this->warning('unhandled GUID "'. self::GUIDname($NextObjectGUIDtext).'" {'.$NextObjectGUIDtext.'} in ASF body at offset '.($offset - 16 - 8));
                        } else {
                    ...
                    switch ($streamdata['information']) {
                        ...
                        default:
                            switch ($streamdata['type_raw']) {
                                case 1:
                                    if (strpos(self::TrimConvert($streamdata['name']), 'Windows Media') !== false) {
                                        $thisfile_video['dataformat'] = 'wmv';
            ...
            if ($thisfile_audio['codec'] ?? '' === 'MPEG Layer-3') {
        ...
        public static function codecListObjectTypeLookup($CodecListType):string {
            static $lookup = array(
                0x0001 => 'Video Codec',
                0x0002 => 'Audio Codec',
        ...
        public static function WMpictureTypeLookup($WMpictureType) {
            ...
            if ($lookup === null) {
                ...
                $lookup = array_map(static function($str) {
                    return getid3_lib::iconv_fallback('UTF-8', 'UTF-16LE', $str);
                }, $lookup);
            }
            return ($lookup[$WMpictureType]?? '');
        }//1706
        public function HeaderExtensionObjectDataParse(&$asf_header_extension_object_data, &$unhandled_sections): array{
                ...
                switch ($thisObject['guid']) {
                    ...
                    default:
                        ...
                        if (self::GUIDname($thisObject['guid_text'])) {
                            $this->warning('unhandled Header Extension Object GUID "'.self::GUIDname($thisObject['guid_text']).'" {'.$thisObject['guid_text'].'} at offset '.($offset - 16 - 8));
                        } else {
        ...
        public function ASF_WMpicture(&$data):string {
            $WMpicture =[];
            $offset = 0;
