    ...
    class getid3_ogg extends getid3_handler{
        public function Analyze():bool {
            ...
            if (strpos($filedata, 'fLaC') === 0) {
                ...
                $filedataoffset += 7;
                $info['ogg']['pageheader']['theora']['version_major']            = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                $info['ogg']['pageheader']['theora']['version_minor']            = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                $info['ogg']['pageheader']['theora']['version_revision']         = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                ...
                $filedataoffset += 3;
                $info['ogg']['pageheader']['theora']['picture_offset_x']         = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                $info['ogg']['pageheader']['theora']['picture_offset_y']         = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                ...
                $filedataoffset += 3;
                $info['ogg']['pageheader']['theora']['color_space_id']           = getid3_lib::BigEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
                ...
                do {
                    ...
                    if (strpos($filedata, "fisbone\x00") === 0) {
                        ...
                        $filedataoffset += 4;
                        $info['ogg']['skeleton']['fisbone']['raw']['granuleshift']            = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
                        ++$filedataoffset;
                ...
                $info['audio']['bitrate_mode'] = 'vbr';
                $info['audio']['lossless']     = true;
                $info['ogg']['flac']['header']['version_major']  = ord($filedata[5]);
                $info['ogg']['flac']['header']['version_minor']  = ord($filedata[6]);
            ...
            switch ($info['audio']['dataformat']) {
                case 'vorbis':
                    ...
                    $info['ogg']['pageheader'][$oggpageinfo['page_seqno']]['packet_type'] = getid3_lib::LittleEndian2Int($filedata[0]);
        ...
        public function ParseVorbisPageHeader(&$filedata, &$filedataoffset, &$oggpageinfo):bool {
            $info = &$this->getid3->info;
            $info['audio']['dataformat'] = 'vorbis';
            $info['audio']['lossless']   = false;
            $info['ogg']['pageheader'][$oggpageinfo['page_seqno']]['packet_type'] = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            ...
            $filedataoffset += 4;
            $info['ogg']['numberofchannels'] = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            ...
            $filedataoffset += 4;
            $info['ogg']['blocksize_small']  = 2 ** (getid3_lib::LittleEndian2Int($filedata[$filedataoffset]) & 0x0F);
            $info['ogg']['blocksize_large']  = 2 ** ((getid3_lib::LittleEndian2Int($filedata[$filedataoffset]) & 0xF0) >> 4);
            $info['ogg']['stop_bit']         = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]); // must be 1, marks end of packet
        ...
        public function ParseOpusPageHeader(&$filedata, &$filedataoffset,&$oggpageinfo):bool {//not used ,
            $info = &$this->getid3->info[$oggpageinfo];//this way?
            ...
            $filedataoffset += 8;
            $info['ogg']['pageheader']['opus']['version']    = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            ...
            $info['ogg']['pageheader']['opus']['out_channel_count'] = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
        ...
        public function ParseOggPageHeader() {
            ...
            $oggheader['stream_structver']  = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            $oggheader['flags_raw']         = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            ...
            $filedataoffset += 4;
            $oggheader['page_segments']     = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
            ++$filedataoffset;
            $oggheader['page_length'] = 0;
            for ($i = 0; $i < $oggheader['page_segments']; $i++) {
                $oggheader['segment_table'][$i] = getid3_lib::LittleEndian2Int($filedata[$filedataoffset]);
                ++$filedataoffset;
        ...
        public function ParseVorbisComments():bool {
            ...
            for ($i = 0; $i < $CommentsCount; $i++) {
                ...
                } elseif (strpos($commentstring, '=') !== false) {
        ...
        public static function OggPageSegmentLength($OggInfoArray, $SegmentNumber=1):int {
            $segmentlength = 0;
        ...
        public static function get_quality_from_nominal_bitrate($nominal_bitrate):float {
            // decrease precision
        ...
        public static function TheoraColorSpace($colorspace_id):?string {
            ...
            return ($TheoraColorSpaceLookup[$colorspace_id] ?? null);
        }
        public static function TheoraPixelFormat($pixelformat_id):?string {
            ...
            return ($TheoraPixelFormatLookup[$pixelformat_id] ?? null);
        }
    }
}else{die;}