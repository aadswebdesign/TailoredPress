    ...
    class getid3_id3v1 extends getid3_handler{
        public function Analyze():bool {
            ...
            if (strpos($id3v1tag, 'TAG') === 0) {
                ...
                $ParsedID3v1['genreid'] = ord($id3v1tag[127]);
                if (($id3v1tag[125] === "\x00") && ($id3v1tag[126] !== "\x00")) {
                    $ParsedID3v1['track_number'] = ord($ParsedID3v1['comment'][29]);
        ...
        public static function cutfield($str):string {
            return trim(substr($str, 0, strcspn($str, "\x00")));
        }
        public static function ArrayOfGenres($allowSCMPXextended=false):string {
         ...
         * @return string
         */
        public static function GenerateID3v1Tag($title, $artist, $album, $year, $genreid, $comment, $track=''):string {
            $ID3v1Tag  = 'TAG';
