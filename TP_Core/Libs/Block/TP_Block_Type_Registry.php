...
if(ABSPATH){
    final class TP_Block_Type_Registry implements _block_interface{
        use _methods_12;
        use _I10n_01;
        ...
        public function unregister( $pattern_name,$properties = null):bool{
        ...
        public function registered( $pattern_name, $property = null ) {
            ...
            return $this->__registered_patterns[ $pattern_name[$property]];
        }
        public function get_all_registered():array {
            return array_values( $this->__registered_patterns );
        }
        public function is_registered( $pattern_name, $property = null ): bool{ //todo let see
            return isset( $this->__registered_patterns[ $pattern_name[$property] ] );
        }
        public static function get_instance(): TP_Block_Type_Registry{
