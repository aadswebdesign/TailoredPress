...
use TP_Core\Libs\PHP\SodiumCompat\lib\hash_context;
use TP_Core\Libs\PHP\SodiumCompat\src\Core\ParagonIE_Util;
use TP_Core\Libs\PHP\SodiumCompat\src\Core\ParagonIE_Ed25519;
use TP_Core\Libs\PHP\SodiumCompat\src\Core\Curve25519\Ge\ParagonIE_Curve25519_P2;
use TP_Core\Libs\PHP\SodiumCompat\src\Core\Curve25519\Ge\ParagonIE_Curve25519_P3;
...
use TypeError;
if(ABSPATH){
    class ParagonIE_File extends ParagonIE_Util{
         ...
         * @throws TypeError
         */
        public static function box($inputFile, $outputFile, $nonce, $keyPair):bool
        {
            /* Type checks: */
            ...
            if (self::strlen($nonce) !== ParagonIE_Compat::CRYPTO_BOX_NONCEBYTES) {
                throw new TypeError('Argument 3 must be CRYPTO_BOX_NONCEBYTES bytes');
            }
            if (self::strlen($keyPair) !== ParagonIE_Compat::CRYPTO_BOX_KEYPAIRBYTES) {
         ...
         * @throws TypeError
         */
        public static function box_open($inputFile, $outputFile, $nonce, $keypair):bool
        {
            /* Type checks: */
            if (!is_string($inputFile)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($inputFile) . ' given.');
            ...
            try {
                ...
                ParagonIE_Compat::memzero($ephKeypair);
         ...
         * @throws TypeError
         */
        public static function box_seal($inputFile, $outputFile, $publicKey):bool
        {
            /* Type checks: */
            if (!is_string($inputFile)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($inputFile) . ' given.');
            ...
            /* Input validation: */
            if (self::strlen($publicKey) !== ParagonIE_Compat::CRYPTO_BOX_PUBLICKEYBYTES) {
            ...
            $ephKeypair = ParagonIE_Compat::crypto_box_keypair();

            /** @var string $msgKeypair */
            $msgKeypair = ParagonIE_Compat::crypto_box_keypair_from_secretkey_and_publickey(
                ParagonIE_Compat::crypto_box_secretkey($ephKeypair),
                $publicKey
            );

            /** @var string $ephemeralPK */
            $ephemeralPK = ParagonIE_Compat::crypto_box_publickey($ephKeypair);

            /** @var string $nonce */
            $nonce = ParagonIE_Compat::crypto_generichash(
            ...
            $firstWrite = fwrite(
                $ofp,
                $ephemeralPK,
                ParagonIE_Compat::CRYPTO_BOX_PUBLICKEYBYTES
            );
            ...
            if ($firstWrite !== ParagonIE_Compat::CRYPTO_BOX_PUBLICKEYBYTES) {
                ParagonIE_Compat::memzero($ephKeypair);
                fclose($ifp);
                fclose($ofp);
         ...
         * @throws TypeError
         */
        public static function box_seal_open($inputFile, $outputFile, $ecdhKeypair):bool
        {
            /* Type checks: */
            if (!is_string($inputFile)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($inputFile) . ' given.');
            ...
            /* Input validation: */
            if (self::strlen($ecdhKeypair) !== ParagonIE_Compat::CRYPTO_BOX_KEYPAIRBYTES) {
                throw new TypeError('Argument 3 must be CRYPTO_BOX_KEYPAIRBYTES bytes');
            }

            $publicKey = ParagonIE_Compat::crypto_box_publickey($ecdhKeypair);
            ...
            $ephemeralPK = fread($ifp, ParagonIE_Compat::CRYPTO_BOX_PUBLICKEYBYTES);
            if (!is_string($ephemeralPK)) {
                throw new SodiumException('Could not read input file');
            }
            if (self::strlen($ephemeralPK) !== ParagonIE_Compat::CRYPTO_BOX_PUBLICKEYBYTES) {
                fclose($ifp);
                fclose($ofp);
            ...
            $msgKeypair = ParagonIE_Compat::crypto_box_keypair_from_secretkey_and_publickey(
                ParagonIE_Compat::crypto_box_secretkey($ecdhKeypair),
                $ephemeralPK
            );
         ...
         */
        public static function generichash($filePath, $key = '', $outputLength = 32):string
        {
            /* Type checks: */
            ...
            /* Input validation: */
            if (!empty($key)) {
                if (self::strlen($key) < ParagonIE_Compat::CRYPTO_GENERICHASH_KEYBYTES_MIN) {
                    throw new TypeError('Argument 2 must be at least CRYPTO_GENERICHASH_KEYBYTES_MIN bytes');
                }
                if (self::strlen($key) > ParagonIE_Compat::CRYPTO_GENERICHASH_KEYBYTES_MAX) {
                    throw new TypeError('Argument 2 must be at most CRYPTO_GENERICHASH_KEYBYTES_MAX bytes');
                }
            }
            if ($outputLength < ParagonIE_Compat::CRYPTO_GENERICHASH_BYTES_MIN) {
                throw new SodiumException('Argument 3 must be at least CRYPTO_GENERICHASH_BYTES_MIN');
            }
            if ($outputLength > ParagonIE_Compat::CRYPTO_GENERICHASH_BYTES_MAX) {
            ...
            $ctx = ParagonIE_Compat::crypto_generichash_init($key, $outputLength);
            while ($size > 0) {
                $blockSize = $size > 64
                    ? 64
                    : $size;
                ...
                ParagonIE_Compat::crypto_generichash_update($ctx, $read);
                $size -= $blockSize;
            }
         ...
         * @throws TypeError
         */
        public static function secretbox($inputFile, $outputFile, $nonce, $key):bool
        {
            /* Type checks: */
            if (!is_string($inputFile)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($inputFile) . ' given..');
            ...
            /* Input validation: */
            if (self::strlen($nonce) !== ParagonIE_Compat::CRYPTO_SECRETBOX_NONCEBYTES) {
            ...
            if (self::strlen($key) !== ParagonIE_Compat::CRYPTO_SECRETBOX_KEYBYTES) {
         ...
         * @throws TypeError
         */
        public static function secretbox_open($inputFile, $outputFile, $nonce, $key):bool
        {
            /* Type checks: */
            if (!is_string($inputFile)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($inputFile) . ' given.');
         ...
         * @throws TypeError
         */
        public static function sign($filePath, $secretKey):string
        {
            /* Type checks: */
            if (!is_string($filePath)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($filePath) . ' given.');
            ...
            /* Input validation: */
            if (self::strlen($secretKey) !== ParagonIE_Compat::CRYPTO_SIGN_SECRETKEYBYTES) {
            ...
            /** @var string $nonce */
            $nonce = ParagonIE_Ed25519::sc_reduce($nonceHash) . self::substr($nonceHash, 32);

            /** @var string $sig */
            $sig = ParagonIE_Ed25519::ge_p3_tobytes(
                ParagonIE_Ed25519::ge_scalarmult_base($nonce)
            );
            ...
            /** @var string $hram */
            $hram = ParagonIE_Ed25519::sc_reduce($hramHash);

            /** @var string $sigAfter */
            $sigAfter = ParagonIE_Ed25519::sc_muladd($hram, $az, $nonce);

            /** @var string $sig */
            $sig = self::substr($sig, 0, 32) . self::substr($sigAfter, 0, 32);

            try {
                ParagonIE_Compat::memzero($az);
            } catch (SodiumException $ex) {
                $az = null;
            }
            fclose($fp);
         ...
         * @throws Exception
         */
        public static function verify($sig, $filePath, $publicKey):bool
        {
            /* Type checks: */
            if (!is_string($sig)) {
            ...
            /* Input validation: */
            if (self::strlen($sig) !== ParagonIE_Compat::CRYPTO_SIGN_BYTES) {
                throw new TypeError('Argument 1 must be CRYPTO_SIGN_BYTES bytes');
            }
            if (self::strlen($publicKey) !== ParagonIE_Compat::CRYPTO_SIGN_PUBLICKEYBYTES) {
            ...
            /* Security checks */
            if (
                (ParagonIE_Ed25519::chrToInt($sig[63]) & 240)
                &&
                ParagonIE_Ed25519::check_S_lt_L(self::substr($sig, 32, 32))
            ) {
                throw new SodiumException('S < L - Invalid signature');
            }
            if (ParagonIE_Ed25519::small_order($sig)) {
            ...
            $orig = ParagonIE_Compat::$fastMult;

            // Set ParagonIE_Sodium_Compat::$fastMult to true to speed up verification.
            ParagonIE_Compat::$fastMult = true;

            /** @var ParagonIE_Curve25519_P3 $A */
            $A = ParagonIE_Ed25519::ge_frombytes_negate_vartime($publicKey);
            ...
            /** @var string $h */
            $h = ParagonIE_Ed25519::sc_reduce($hDigest) . self::substr($hDigest, 32);

            /** @var ParagonIE_Curve25519_P2 $R */
            $R = ParagonIE_Ed25519::ge_double_scalarmult_vartime(
                $h,
                $A,
                self::substr($sig, 32)
            );
            ...
            /** @var string $rcheck */
            $rcheck = ParagonIE_Ed25519::ge_tobytes($R);

            // Close the file handle
            fclose($fp);

            // Reset ParagonIE_Sodium_Compat::$fastMult to what it was before.
            ParagonIE_Compat::$fastMult = $orig;
         ...
         * @throws TypeError
         */
        protected static function box_encrypt($ifp, $ofp, $mlen, $nonce, $boxKeypair):bool
        {
            if (PHP_INT_SIZE === 4) {
                return self::secretbox_encrypt(
                    ...
                    $mlen,
                    $nonce,
                    ParagonIE_Crypto32::box_beforenm(
                        ParagonIE_Crypto32::box_secretkey($boxKeypair),
                        ParagonIE_Crypto32::box_publickey($boxKeypair)
                    )
                );
            }
            return self::secretbox_encrypt(
                ...
                $mlen,
                $nonce,
                ParagonIE_Crypto::box_beforenm(
                    ParagonIE_Crypto::box_secretkey($boxKeypair),
                    ParagonIE_Crypto::box_publickey($boxKeypair)
                )
            );
        }
         ...
         * @throws TypeError
         */
        protected static function box_decrypt($ifp, $ofp, $mlen, $nonce, $boxKeypair):bool
        {
            if (PHP_INT_SIZE === 4) {
         ...
         * @throws TypeError
         */
        protected static function secretbox_encrypt($ifp, $ofp, $mlen, $nonce, $key):bool
        {
            if (PHP_INT_SIZE === 4) {
            ...
            $realNonce = ParagonIE_Util::substr($nonce, 16, 8);
            ...
            $mlen0 = $mlen;
            if ($mlen0 > 64 - ParagonIE_Crypto::secretbox_xsalsa20poly1305_ZEROBYTES) {
                $mlen0 = 64 - ParagonIE_Crypto::secretbox_xsalsa20poly1305_ZEROBYTES;
            }
            ...
            $state = new ParagonIE_Poly1305_State(
                ParagonIE_Util::substr(
                    $block0,
                    0,
                    ParagonIE_Crypto::onetimeauth_poly1305_KEYBYTES
                )
            );
            ...
            /** @var string $c */
            $cBlock = ParagonIE_Util::substr(
                $block0,
                ParagonIE_Crypto::secretbox_xsalsa20poly1305_ZEROBYTES
            );
            $state->update($cBlock);
            fwrite($ofp, $cBlock);
            $mlen -= 32;
            ...
            while ($mlen > 0) {
                ...
                $cBlock = ParagonIE_Salsa20::salsa20_xor_ic(
                    $plaintext,
                    $realNonce,
                    $iter,
                    $subkey
            ...
            fwrite($ofp, $state->finish(), ParagonIE_Compat::CRYPTO_SECRETBOX_MACBYTES);
         ...
         * @throws TypeError
         */
        protected static function secretbox_decrypt($ifp, $ofp, $mlen, $nonce, $key):bool
        {
            if (PHP_INT_SIZE === 4) {
            ...
            $state = new ParagonIE_Poly1305_State(self::substr($block0, 0, 32));
            ...
            while ($mlen > 0) {
                ...
                $pBlock = ParagonIE_Salsa20::salsa20_xor_ic(
                    $ciphertext,
                    $realNonce,
                    $iter,
                    $subkey
        ...
        /**
         * @param ParagonIE_Poly1305_State $state
         * @param resource $ifp
         * @param string $tag
         * @param int $mlen
         * @return bool
        ...
        protected static function onetimeauth_verify(
            ParagonIE_Poly1305_State $state,
            $ifp,
            $tag = '',
            $mlen = 0
        ):bool {
            ...
            $res = ParagonIE_Util::verify_16($tag, $state->finish());
         ...
         *
         * @param resource|hash_context $hash
         * @param resource $fp
         * @param int $size
         ...
         * @throws TypeError
         */
        private static function sign_core32($filePath, $secretKey):string
        {
            /** @var int|bool $size */
            $size = filesize($filePath);
            if (!is_int($size)) {
            ...
            /** @var string $nonce */
            $nonce = ParagonIE_32_Ed25519::sc_reduce($nonceHash) . self::substr($nonceHash, 32);

            /** @var string $sig */
            $sig = ParagonIE_32_Ed25519::ge_p3_tobytes(
                ParagonIE_32_Ed25519::ge_scalarmult_base($nonce)
            );
            ...
            /** @var string $hram */
            $hram = ParagonIE_32_Ed25519::sc_reduce($hramHash);

            /** @var string $sigAfter */
            $sigAfter = ParagonIE_32_Ed25519::sc_muladd($hram, $az, $nonce);
         ...
         * @throws Exception
         */
        public static function verify_core32($sig, $filePath, $publicKey):bool
        {
            /* Security checks */
            if (ParagonIE_32_Ed25519::check_S_lt_L(self::substr($sig, 32, 32))) {
                throw new SodiumException('S < L - Invalid signature');
            }
            if (ParagonIE_32_Ed25519::small_order($sig)) {
                throw new SodiumException('Signature is on too small of an order');
            }
            if ((self::chrToInt($sig[63]) & 224) !== 0) {
                throw new SodiumException('Invalid signature');
            ...
            /** @var ParagonIE_32_Curve25519_P3 $A */
            $A = ParagonIE_32_Ed25519::ge_frombytes_negate_vartime($publicKey);
            ...
            /** @var string $h */
            $h = ParagonIE_32_Ed25519::sc_reduce($hDigest) . self::substr($hDigest, 32);

            /** @var ParagonIE_32_Curve25519_P2 $R */
            $R = ParagonIE_32_Ed25519::ge_double_scalarmult_vartime(
                $h,
                $A,
                self::substr($sig, 32)
            );
            ...
            /** @var string $rcheck */
            $rcheck = ParagonIE_32_Ed25519::ge_tobytes($R);
         ...
         * @throws TypeError
         */
        protected static function secretbox_encrypt_core32($ifp, $ofp, $mlen, $nonce, $key):bool
        {
            $plaintext = fread($ifp, 32);
            if (!is_string($plaintext)) {
                throw new SodiumException('Could not read input file');
            ...
            /** @var string $realNonce */
            $realNonce = ParagonIE_32_Util::substr($nonce, 16, 8);
            ...
            /** @var string $c */
            $cBlock = ParagonIE_32_Util::substr(
                $block0,
                ParagonIE_Crypto::secretbox_xsalsa20poly1305_ZEROBYTES
            );
            $state->update($cBlock);
            ...
            while ($mlen > 0) {
                ...
                $cBlock = ParagonIE_32_Salsa20::salsa20_xor_ic(
                    $plaintext,
                    $realNonce,
                    $iter,
                    $subkey
         ...
         * @throws TypeError
         */
        protected static function secretbox_decrypt_core32($ifp, $ofp, $mlen, $nonce, $key):bool
        {
            $tag = fread($ifp, 16);
            if (!is_string($tag)) {
                throw new SodiumException('Could not read input file');
            ...
            /* Verify the Poly1305 MAC -before- attempting to decrypt! */
            $state = new ParagonIE_32_Poly1305_State(self::substr($block0, 0, 32));
            ...
            while ($mlen > 0) {
                ...
                $pBlock = ParagonIE_32_Salsa20::salsa20_xor_ic(
                    $ciphertext,
                    $realNonce,
                    $iter,
                    $subkey
         ...
         *
         * @param ParagonIE_32_Poly1305_State $state
         * @param resource $ifp
         * @param string $tag
         * @param int $mlen
         * @return bool
        ...
        protected static function onetimeauth_verify_core32(
            ParagonIE_32_Poly1305_State $state,
            $ifp,
            $tag = '',
            $mlen = 0
        ):bool {
            ...
            $res = ParagonIE_32_Util::verify_16($tag, $state->finish());
