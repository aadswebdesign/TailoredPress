...
use TypeError;
if(ABSPATH){
    class ParagonIE_X25519 extends ParagonIE_Curve25519{
        /**
         ...
         */
        public static function fe_mul121666(ParagonIE_Curve25519_Fe $f):ParagonIE_Curve25519_Fe
        {
            $h = array(
         ...
         * @internal You should not use this directly from another application
         *
         * @param ParagonIE_Curve25519_Fe $edwardsY
         * @param ParagonIE_Curve25519_Fe $edwardsZ
         * @return ParagonIE_Curve25519_Fe
         */
        public static function edwards_to_montgomery(
            ParagonIE_Curve25519_Fe $edwardsY,
            ParagonIE_Curve25519_Fe $edwardsZ
        ...
        public static function crypto_scalarmult_curve25519_ref10_base($n):string
        {
            ...
            if (
                !($A->Y instanceof ParagonIE_Curve25519_Fe)
                ||
                !($A->Z instanceof ParagonIE_Curve25519_Fe)
            ) {
