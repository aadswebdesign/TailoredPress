...
use ArrayAccess;
if(ABSPATH){
    abstract class ParagonIE_Util{
        /**
         * @param int $integer
         * @param int $size (16, 32, 64)
         * @return int
         */
        public static function abs($integer, $size = 0):int
        {
            /** @var int $realSize */
         ...
         * @throws TypeError
         */
        public static function bin2hex($binaryString):string
        {
            /* Type checks: */
         ...
         * @throws TypeError
         */
        public static function bin2hexUpper($bin_string):string
        {
            $hex = '';
         ...
         * @throws TypeError
         */
        public static function chrToInt($chr):int
        {
            /* Type checks: */
            if (!is_string($chr)) {
         ...
         * @throws TypeError
         */
        public static function compare($left, $right, $len = null):int
        {
         ...
         * @return void
         */
        public static function declareScalarType(&$mixedVar = null, $type = 'void', $argumentIndex = 0):void
        {
            if (func_num_args() === 0) {
         ...
         * @throws TypeError
         */
        public static function hashEquals($left, $right):bool
        {
            /* Type checks: */
            if (!is_string($left)) {
         ...
         *
         * @param resource &$hs //HashContext
         * @param string $data
         * @return void
         * @throws SodiumException
         * @psalm-suppress PossiblyInvalidArgument
         */
        protected static function hash_update(&$hs, $data):void
        {
         ...
         * @throws TypeError
         */
        public static function hex2bin($hexString, $strictPadding = false):string
        {
            /* Type checks: */
         ...
         * @throws TypeError
         */
        public static function intToChr($int):string
        {
            return pack('C', $int);
        }
         ...
         * @throws TypeError
         */
        public static function load_3($string):int
        {
            /* Type checks: */
            if (!is_string($string)) {
         ...
         * @throws TypeError
         */
        public static function load_4($string):int
        {
            /* Type checks: */
            if (!is_string($string)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($string) . ' given.');
         ...
         * @throws TypeError
         */
        public static function load64_le($string):int
        {
            /* Type checks: */
            if (!is_string($string)) {
                throw new TypeError('Argument 1 must be a string, ' . gettype($string) . ' given.');
         ...
         * @return int
         */
        public static function mul($a, $b, $size = 0):int
        {
         ...
         * @throws TypeError
         */
        public static function store_3($int):string
        {
            /* Type checks: */
            if (!is_int($int)) {
                if (is_numeric($int)) {
         ...
         * @throws TypeError
         */
        public static function store32_le($int):string
        {
            /* Type checks: */
            if (!is_int($int)) {
                if (is_numeric($int)) {
         ...
         * @throws TypeError
         */
        public static function store_4($int):string
        {
            /* Type checks: */
            if (!is_int($int)) {
                if (is_numeric($int)) {
         ...
         * @throws TypeError
         */
        public static function store64_le($int):string
        {
            /* Type checks: */
            if (!is_int($int)) {
                if (is_numeric($int)) {
         ...
         * @throws TypeError
         */
        public static function stringToIntArray($string):array
        {
            if (!is_string($string)) {
                throw new TypeError('String expected');
            }
         ...
         * @throws TypeError
         */
        public static function verify_16($a, $b):bool
        {
            /* Type checks: */
            if (!is_string($a)) {
                throw new TypeError('String expected');
         ...
         * @throws TypeError
         */
        public static function verify_32($a, $b):bool
        {
            /* Type checks: */
            if (!is_string($a)) {
                throw new TypeError('String expected');
         ...
         * @throws TypeError
         */
        public static function xorStrings($a, $b):string
        {
            /* Type checks: */
            if (!is_string($a)) {
