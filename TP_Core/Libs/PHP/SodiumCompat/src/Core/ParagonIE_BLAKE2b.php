...
if(ABSPATH){
    class ParagonIE_BLAKE2b extends ParagonIE_Util {
        /**
         * @var SplFixedArray
         */
        protected static $iv;
         ...
         */
        public static function new64($high, $low):SplFixedArray
        {
         ...
         * @return SplFixedArray
         */
        protected static function to64($num):SplFixedArray
        {
         ...
         */
        protected static function add64($x, $y):SplFixedArray
        {
         ...
         * @return SplFixedArray
         */
        protected static function add364($x, $y, $z):SplFixedArray
        {
         ...
         * @psalm-suppress MixedAssignment
         */
        public static function rotr64($x, $c):SplFixedArray
        {
            if ($c >= 64) {
                $c %= 64;
            }
            ...
            if ($c1 < 32) {
                ...
                $h1 = (int) ($x[0]) >> $c1;
                /** @var int $l1 */
                $l1 = (($x[1]) >> $c1) | ((int) ($x[0]) & ((1 << $c1) - 1)) << (32 - $c1);
            } else {
                /** @var int $l1 */
                $l1 = (int) ($x[0]) >> ($c1 - 32);
            }
         ...
         * @psalm-suppress MixedOperand
         */
        protected static function flatten64($x):int
        {
         ...
         */
        protected static function load64(SplFixedArray $x, $i):SplFixedArray
        {
            /** @var int $l */
            $l = (int) ($x[$i])
                | ((int) ($x[$i+1]) << 8)
         ...
         * @psalm-suppress MixedAssignment
         */
        protected static function store64(SplFixedArray $x, $i, SplFixedArray $u):void
        {
