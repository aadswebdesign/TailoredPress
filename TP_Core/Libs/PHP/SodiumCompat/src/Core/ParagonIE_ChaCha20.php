...
use TypeError;
if(ABSPATH){
    class ParagonIE_ChaCha20 extends ParagonIE_Util{
        /**
         ...
         * @return int
         */
        public static function rotate($v, $n):int
        {
            $v &= 0xffffffff;
            $n &= 31;
            return (
         ...
         */
        protected static function quarterRound($a, $b, $c, $d):array
        {
         ...
         * @internal You should not use this directly from another application
         *
         * @param ParagonIE_ChaCha20_Ctx $ctx
        ...
        public static function stream($len = 64, $nonce = '', $key = ''):string
        {
            return self::encryptBytes(
                new ParagonIE_ChaCha20_Ctx($key, $nonce),
                str_repeat("\x00", $len)
            );
        }
        ...
        {
            return self::encryptBytes(
                new ParagonIE_ChaCha20_IetfCtx($key, $nonce),
                str_repeat("\x00", $len)
            );
        }
        ...
        {
            return self::encryptBytes(
                new ParagonIE_ChaCha20_IetfCtx($key, $nonce, $ic),
                $message
            );
        }
        ...
        {
            return self::encryptBytes(
                new ParagonIE_ChaCha20_Ctx($key, $nonce, $ic),
                $message
            );
        }
    }
