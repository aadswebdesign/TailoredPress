...
use Exception;
if(ABSPATH){
    class ParagonIE_Ristretto255 extends ParagonIE_Ed25519{
         ...
         */
        public static function fe_cneg(ParagonIE_Curve25519_Fe $f, $b):ParagonIE_Curve25519_Fe
        {
            $negf = self::fe_neg($f);
         ...
         */
        public static function fe_abs(ParagonIE_Curve25519_Fe $f):ParagonIE_Curve25519_Fe
        {
         ...
         * @throws SodiumException
         */
        public static function fe_iszero(ParagonIE_Curve25519_Fe $f):int
        {
            static $zero;
            if ($zero === null) {
        ...
        /**
         * @param ParagonIE_Curve25519_Fe $u
         * @param ParagonIE_Curve25519_Fe $v
         * @return array{x: ParagonIE_Sodium_Core_Curve25519_Fe, nonsquare: int}
         *
         * @throws SodiumException
         */
        public static function ristretto255_sqrt_ratio_m1(
            ParagonIE_Curve25519_Fe $u,
            ParagonIE_Curve25519_Fe $v
        ):array {
            $sqrtm1 = ParagonIE_Curve25519_Fe::fromArray(self::$sqrtm1);
         ...
         * @throws SodiumException
         */
        public static function ristretto255_point_is_canonical($s):int
        {
         ...
         * @throws SodiumException
         */
        public static function ristretto255_frombytes($s, $skipCanonicalCheck = false):array
        {
            ...
            $v = self::fe_mul(
                ParagonIE_Curve25519_Fe::fromArray(self::$d),
                $u1u1
            ); /* v = d*u1^2 */
         ...
         * @throws SodiumException
         */
        public static function ristretto255_p3_tobytes(ParagonIE_Curve25519_P3 $h):string
        {
            $sqrtm1 = ParagonIE_Curve25519_Fe::fromArray(self::$sqrtm1);
            $invsqrtamd = ParagonIE_Curve25519_Fe::fromArray(self::$invsqrtamd);
        ...
        /**
         * @param ParagonIE_Curve25519_Fe $t
         * @return ParagonIE_Curve25519_P3
         *
         * @throws SodiumException
         */
        public static function ristretto255_elligator(ParagonIE_Curve25519_Fe $t):ParagonIE_Curve25519_P3
        {
            $sqrtm1   = ParagonIE_Curve25519_Fe::fromArray(self::$sqrtm1);
            $onemsqd  = ParagonIE_Curve25519_Fe::fromArray(self::$onemsqd);
            $d        = ParagonIE_Curve25519_Fe::fromArray(self::$d);
            $sqdmone  = ParagonIE_Curve25519_Fe::fromArray(self::$sqdmone);
            $sqrtadm1 = ParagonIE_Curve25519_Fe::fromArray(self::$sqrtadm1);
         ...
         * @throws SodiumException
         */
        public static function ristretto255_from_hash($h):string
        {
            if (self::strlen($h) !== 64) {
         ...
         * @throws SodiumException
         */
        public static function is_valid_point($p):int
        {
         ...
         * @throws SodiumException
         */
        public static function ristretto255_add($p, $q):string
        {
         ...
         * @throws SodiumException
         */
        public static function ristretto255_sub($p, $q):string
        {
            $p_res = self::ristretto255_frombytes($p);
            $q_res = self::ristretto255_frombytes($q);
            if ($p_res['res'] !== 0 || $q_res['res'] !== 0) {
         ...
         */
        protected static function h2c_string_to_hash_sha256($hLen, $ctx, $msg):string
        {
         ...
         * @psalm-suppress PossiblyInvalidArgument hash API
         */
        protected static function h2c_string_to_hash_sha512($hLen, $ctx, $msg):string
        {
            $h = array_fill(0, $hLen, 0);
            $ctx_len = !is_null($ctx) ? self::strlen($ctx) : 0;
            if ($hLen > 0xff) {
         ...
         * @throws SodiumException
         */
        public static function h2c_string_to_hash($hLen, $ctx, $msg, $hash_alg):string
        {
            switch ($hash_alg) {
         ...
         * @throws SodiumException
         */
        protected static function _string_to_element($ctx, $msg, $hash_alg):string
        {
        ...
        {
            return self::ristretto255_from_hash(
                ParagonIE_Compat::randombytes_buf(self::crypto_core_ristretto255_HASHBYTES)
            );
        }
         ...
         * @throws SodiumException
         */
        public static function ristretto255_scalar_complement($s):string
        {
         ...
         * @return string
         */
        public static function ristretto255_scalar_invert($s):string
        {
         ...
         * @throws SodiumException
         */
        public static function ristretto255_scalar_negate($s):string
        {
         ...
         * @return string
         */
        public static function ristretto255_scalar_add($x, $y):string
        {
         ...
         * @return string
         */
        public static function ristretto255_scalar_sub($x, $y):string
        {
         ...
         * @return string
         */
        public static function ristretto255_scalar_mul($x, $y):string
        {
         ...
         * @throws SodiumException
         */
        public static function ristretto255_scalar_from_string($ctx, $msg, $hash_alg):string
        {
            $h = array_fill(0, 64, 0);
         ...
         * @return string
         */
        public static function ristretto255_scalar_reduce($s):string
        {
         ...
         * @throws SodiumException
         */
        public static function scalarmult_ristretto255($n, $p):string
        {
            if (self::strlen($n) !== 32) {
         ...
         * @throws SodiumException
         */
        public static function scalarmult_ristretto255_base($n):string
        {
            $t = self::stringToIntArray($n);
            $t[31] &= 0x7f;
