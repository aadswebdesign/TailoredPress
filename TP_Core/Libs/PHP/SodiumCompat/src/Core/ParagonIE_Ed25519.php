...
use TypeError;
if(ABSPATH){
    abstract class ParagonIE_Ed25519 extends ParagonIE_Curve25519{
        use SodiumMethods;
         ...
         * @throws TypeError
         */
        public static function seed_keypair(&$pk, &$sk, $seed):string
        {
         ...
         * @throws TypeError
         */
        public static function secretkey($keypair):string
        {
         ...
         * @throws TypeError
         */
        public static function publickey($keypair):string
        {
            if (self::strlen($keypair) !== self::KEYPAIR_BYTES) {
                throw new RangeException('crypto_sign keypair must be 96 bytes long');
            }
         ...
         * @throws TypeError
         */
        public static function publickey_from_secretkey($sk):string
        {
            /** @var string $sk */
         ...
         * @throws TypeError
         */
        public static function pk_to_curve25519($pk):string
        {
         ...
         * @throws TypeError
         */
        public static function sk_to_pk($sk):string
        {
         ...
         * @throws TypeError
         */
        public static function sign_open($message, $pk):string
        {
            /** @var string $signature */
         ...
         * @throws TypeError
         */
        public static function verify_detached($sig, $message, $pk):bool
        {
         ...
         * @throws TypeError
         */
        public static function check_S_lt_L($S):bool
        {
            if (self::strlen($S) < 32) {
         ...
         * @throws TypeError
         */
        public static function small_order($R):bool
        {
         ...
         * @throws SodiumException
         */
        public static function scalar_complement($s):string
        {
            $t_ = self::L . str_repeat("\x00", 32);
            (new static)->_sodium_increment($t_);
            $s_ = $s . str_repeat("\x00", 32);
            ParagonIE_Compat::sub($t_, $s_);
        ...
        {
            do {
                $r = ParagonIE_Compat::randombytes_buf(self::SCALAR_BYTES);
                $r[self::SCALAR_BYTES - 1] = self::intToChr(
                    self::chrToInt($r[self::SCALAR_BYTES - 1]) & 0x1f
                );
            } while (
                !self::check_S_lt_L($r) || ParagonIE_Compat::is_zero($r)
            );
            return $r;
        }
         ...
         * @throws SodiumException
         */
        public static function scalar_negate($s):string
        {
            $t_ = self::L . str_repeat("\x00", 32) ;
            $s_ = $s . str_repeat("\x00", 32) ;
            ParagonIE_Compat::sub($t_, $s_);
         ...
         * @throws SodiumException
         */
        public static function scalar_add($a, $b):string
        {
            $a_ = $a . str_repeat("\x00", 32);
            $b_ = $b . str_repeat("\x00", 32);
            ParagonIE_Compat::add($a_, $b_);
         ...
         * @throws SodiumException
         */
        public static function scalar_sub($x, $y):string
        {
