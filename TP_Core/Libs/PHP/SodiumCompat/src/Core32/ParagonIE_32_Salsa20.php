...
use RangeException;
if(ABSPATH){
    abstract class ParagonIE_32_Salsa20 extends ParagonIE_32_Util{
         ...
         * @throws TypeError
         */
        public static function core_salsa20($in, $k, $c = null):string
        {
            /**
             ...
             * @var ParagonIE_32_Int32 $j0
             * @var ParagonIE_32_Int32 $j1
             * @var ParagonIE_32_Int32 $j2
             * @var ParagonIE_32_Int32 $j3
             * @var ParagonIE_32_Int32 $j4
             * @var ParagonIE_32_Int32 $j5
             * @var ParagonIE_32_Int32 $j6
             * @var ParagonIE_32_Int32 $j7
             * @var ParagonIE_32_Int32 $j8
             * @var ParagonIE_32_Int32 $j9
             * @var ParagonIE_32_Int32 $j10
             * @var ParagonIE_32_Int32 $j11
             * @var ParagonIE_32_Int32 $j12
             * @var ParagonIE_32_Int32 $j13
             * @var ParagonIE_32_Int32 $j14
             * @var ParagonIE_32_Int32 $j15
             */
            if (self::strlen($k) < 32) {
                throw new RangeException('Key must be 32 bytes long');
            }
            if ($c === null) {
                $x0  = new ParagonIE_32_Int32(array(0x6170, 0x7865));
                $x5  = new ParagonIE_32_Int32(array(0x3320, 0x646e));
                $x10 = new ParagonIE_32_Int32(array(0x7962, 0x2d32));
                $x15 = new ParagonIE_32_Int32(array(0x6b20, 0x6574));
            } else {
                $x0  = ParagonIE_32_Int32::fromReverseString(self::substr($c, 0, 4));
                $x5  = ParagonIE_32_Int32::fromReverseString(self::substr($c, 4, 4));
                $x10 = ParagonIE_32_Int32::fromReverseString(self::substr($c, 8, 4));
                $x15 = ParagonIE_32_Int32::fromReverseString(self::substr($c, 12, 4));
            }
            $x1  = ParagonIE_32_Int32::fromReverseString(self::substr($k, 0, 4));
            $x2  = ParagonIE_32_Int32::fromReverseString(self::substr($k, 4, 4));
            $x3  = ParagonIE_32_Int32::fromReverseString(self::substr($k, 8, 4));
            $x4  = ParagonIE_32_Int32::fromReverseString(self::substr($k, 12, 4));
            $x6  = ParagonIE_32_Int32::fromReverseString(self::substr($in, 0, 4));
            $x7  = ParagonIE_32_Int32::fromReverseString(self::substr($in, 4, 4));
            $x8  = ParagonIE_32_Int32::fromReverseString(self::substr($in, 8, 4));
            $x9  = ParagonIE_32_Int32::fromReverseString(self::substr($in, 12, 4));
            $x11 = ParagonIE_32_Int32::fromReverseString(self::substr($k, 16, 4));
            $x12 = ParagonIE_32_Int32::fromReverseString(self::substr($k, 20, 4));
            $x13 = ParagonIE_32_Int32::fromReverseString(self::substr($k, 24, 4));
            $x14 = ParagonIE_32_Int32::fromReverseString(self::substr($k, 28, 4));
         ...
         * @throws TypeError
         */
        public static function salsa20($len, $nonce, $key):string
        {
            ...
            try {
                ParagonIE_Compat::memzero($kcopy);
         ...
         * @throws TypeError
         */
        public static function salsa20_xor_ic($m, $n, $ic, $k):string
        {
            $mlen = self::strlen($m);
            if ($mlen < 1) {
                return '';
            ...
            $in .= ParagonIE_32_Util::store64_le($ic);
            ...
            try {
                ParagonIE_Compat::memzero($block);
                ParagonIE_Compat::memzero($kcopy);
            } catch (SodiumException $ex) {
                $block = null;
                $kcopy = null;
         ...
         * @throws TypeError
         */
        public static function salsa20_xor($message, $nonce, $key):string
        {
