...
use TypeError;
if(ABSPATH){
    class ParagonIE_32_SipHash extends ParagonIE_32_Util{
        /**
         ...
         * @throws TypeError
         */
        public static function sipHash24($in, $key):string
        {
            ...
            $k = array(
                ParagonIE_32_Int64::fromReverseString(
                    self::substr($key, 0, 8)
                ),
                ParagonIE_32_Int64::fromReverseString(
                    self::substr($key, 8, 8)
            ...
            while ($left >= 8) {
                # m = LOAD64_LE( in );
                $m = ParagonIE_32_Int64::fromReverseString(
                    self::substr($in, 0, 8)
                );
