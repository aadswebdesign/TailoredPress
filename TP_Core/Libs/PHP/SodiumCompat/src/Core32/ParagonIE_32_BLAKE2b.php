...
use TypeError;
if(ABSPATH){
    abstract class ParagonIE_32_BLAKE2b extends ParagonIE_Util{
        /**
         * @var SplFixedArray
         */
        public static $iv;
         ...
         * @throws TypeError
         */
        public static function new64($high, $low):ParagonIE_32_Int64
        {
            return ParagonIE_32_Int64::fromInts($low, $high);
        }
         ...
         * @throws TypeError
         */
        protected static function to64($num):ParagonIE_32_Int64
        {
         ...
         * @internal You should not use this directly from another application
         *
         * @param ParagonIE_32_Int64 $x
         * @param ParagonIE_32_Int64 $y
         * @return ParagonIE_32_Int64
         */
        protected static function add64($x, $y):ParagonIE_32_Int64
        {
            return $x->addInt64($y);
        }
         ...
         * @param ParagonIE_32_Int64 $x
         * @param ParagonIE_32_Int64 $y
         * @param ParagonIE_32_Int64 $z
         * @return ParagonIE_32_Int64
         */
        public static function add364($x, $y, $z):ParagonIE_32_Int64
        {
         ...
         * @throws TypeError
         */
        public static function xor64(ParagonIE_32_Int64 $x, ParagonIE_32_Int64 $y):ParagonIE_32_Int64
        {
            return $x->xorInt64($y);
        }
         ...
         * @throws TypeError
         */
        public static function rotr64(ParagonIE_32_Int64 $x, $c):ParagonIE_32_Int64
        {
         ...
         * @throws TypeError
         */
        public static function load64($x, $i):ParagonIE_32_Int64
        {
            /** @var int $l */
            $l = (int) ($x[$i])
                | ((int) ($x[$i+1]) << 8)
         ...
         */
        public static function store64(SplFixedArray $x, $i, ParagonIE_32_Int64 $u):void
        {
            $v = clone $u;
         ...
         * @psalm-suppress MixedArrayOffset
         */
        public static function G($r, $i, $a, $b, $c, $d, SplFixedArray $v, SplFixedArray $m):SplFixedArray
        {
         ...
         * @psalm-suppress MixedArrayAssignment
         */
        public static function increment_counter($ctx, $inc):void
        {
            if ($inc < 0) {
            ...
            # S->t[1] += ( S->t[0] < inc );
            if (!($ctx[1][0] instanceof ParagonIE_32_Int64)) {
                throw new TypeError('Not an int64');
            }
            /** @var ParagonIE_32_Int64 $c*/
            $c = $ctx[1][0];
         ...
         */
        public static function update(SplFixedArray $ctx, SplFixedArray $p, $plen):void
        {
         ...
         */
        public static function stringToSplFixedArray($str = ''):SplFixedArray
        {
            $values = unpack('C*', $str);
        ...
        public static function contextToString(SplFixedArray $ctx):string
        {
            ...
            # uint64_t h[8];
            for ($i = 0; $i < 8; ++$i) {
                if (!($ctxA[$i] instanceof ParagonIE_32_Int64)) {
                    throw new TypeError('Not an instance of Int64');
                }
                /** @var ParagonIE_32_Int64 $ctxAi */
                $ctxAi = $ctxA[$i];
            ...
            for ($i = 1; $i < 3; ++$i) {
                /** @var array<int, ParagonIE_Sodium_Core32_Int64> $ctxA */
                $ctxA = $ctx[$i]->toArray();
                /** @var ParagonIE_32_Int64 $ctxA1 */
                /** @var ParagonIE_32_Int64 $ctxA2 */
                @list($ctxA1,$ctxA2) = $ctxA;
         ...
         * @psalm-suppress MixedArrayAssignment
         */
        public static function stringToContext($string):SplFixedArray
        {
            $ctx = self::context();

            # uint64_t h[8];
            for ($i = 0; $i < 8; ++$i) {
                $ctx[0][$i] = ParagonIE_32_Int64::fromReverseString(
            ...
            # uint64_t f[2];
            for ($i = 1; $i < 3; ++$i) {
                $ctx[$i][1] = ParagonIE_32_Int64::fromReverseString(
                    self::substr($string, 72 + (($i - 1) << 4), 8)
                );
                $ctx[$i][0] = ParagonIE_32_Int64::fromReverseString(
