...
if(ABSPATH){
    trait _general_template_01 {
        ...
        protected function _get_header($header_args = null, $args = null):?string{ //TP_NS_THEME_TEMPLATE TP_NS_THEMES
            ...
            $theme_name = $header_args['theme_name'] ?? TP_NS_DEFAULT_THEME; //the default theme
        ...
        protected function _get_footer($footer_args = null, $args = null):string{
            ...
            $theme_name = $footer_args['theme_name'] ?? TP_NS_DEFAULT_THEME; //the default theme
        ...
        protected function _get_sidebar($sidebar_args = null, $args = null):string{
            ...
            $theme_name = $sidebar_args['theme_name'] ?? TP_NS_DEFAULT_THEME;
        ...
        protected function _get_partial($partial_args = null, $args = null):string{
            ...
            $theme_name = $partial_args['theme_name'] ?? TP_NS_DEFAULT_THEME;
        ...
        protected function _get_search_form($search_args = null, $args = null):?string{
            ...
            $theme_name = $search_args['theme_name'] ?? TP_NS_DEFAULT_THEME;
            $output = "";
            $defaults = ['aria_label' => '',];
            ...
            $output .= $this->_tp_load_class('theme_search',TP_NS_THEMES.$theme_name.TP_NS_THEME_COMPONENTS, 'SearchForm',$args);
