 ...
 * Time: 22:25
 */
namespace TP_Admin\Libs\AdmForms;
...
if(ABSPATH){
    class TP_Install_Form{
        use _action_01, _adm_template_04, _construct_db;
        use _formats_02, _formats_08, _formats_10, _formats_11;
        use _general_template_09, _k_ses_03, _init_db;
        use _I10n_01,_I10n_02,_I10n_03,_I10n_04,_I10n_05;
        use _option_01, _pluggable_05;
        protected $_args, $_form_args, $_html;
        public $tp_filter;
        /**
         * TP_Install_Form constructor.
         * @param array $args
         */
        ...
        private function __to_string():string{
            ...
            $this->_html .= "<div class='block step-two install-form'>";
            ...
            if ( $this->_has_action( 'blog_privacy_selector' ) ) {
                $this->_html .= "<li><dd><input name='blog_public' id='get_blog' type='radio' value='1' {$this->_get_checked( 1, $this->_form_args['blog_public'] )} /></dd>";
                $this->_html .= "<dt><label for='get_blog'>{$this->__('Allow search engines to index this site.')}</label></dt></li><li>";
                ...
                $this->_html .= "</li><li>";
                $this->_html .= $this->_get_action( 'blog_privacy_selector' );
                $this->_html .= "</li>";
            }else{
                $this->_html .= "<li><dd><input name='blog_public' id='blog_public' type='checkbox' value='0' {$this->_get_checked(0, $this->_form_args['blog_public'] )} /></dd>";
                $this->_html .= "<dt><label for='blog_public'>{$this->__('Discourage search engines from indexing this site')}</label></dt>";
                $this->_html .= "<dt><p class='description'>{$this->__('It is up to search engines to honor this request.')}</p></dt></li>";
            }
